...
# Function to handle text input and responses
...
chatbox.pack(padx=20, pady=20, fill=tk.BOTH, expand=True)
...
speak_button = tk.Button(input_frame, text="قل شيئًا", font=("Arial", 14), bg="#2ecc71", fg="#ffffff", command=handle_speech_input)
